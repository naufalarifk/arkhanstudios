...
function Header() {
  ...
  const [navColor, setnavColor] = useState(
    window.scrollY > 10 ? "black" : "transparent"
  );
      ...
      <header className={`fixed w-full top-0 z-10`}>
        ...
        >
          <div className="flex flex-wrap justify-between py-4 lg:py-0 md:px-12 lg:px-0 lg:justify-between items-center mx-auto max-w-screen-xl">
            ...
            <ul className="hidden lg:flex flex-col mt-4 font-medium md:flex-row lg:space-x-2 lg:mt-0">
              <li>
                <Link
                  to="/mascot-design"
                  className={`${
                    ...
                    splitLocation[1] === "other-design"
                      ? "text-white"
                      : "text-gray-400"
                  } block py-2 hover:text-white font-semibold pr-4 pl-3`}
                  aria-current="page"
                >
                  PORTFOLIO
                </Link>
